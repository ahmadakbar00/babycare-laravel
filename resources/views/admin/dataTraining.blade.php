...
@endif
  ...
  <div data-toggle="modal" data-target="#dataTrainingModal" class="btn btn-primary">Add Data Training</div>
...
<!-- Modal -->
<div class="modal fade" id="dataTrainingModal" tabindex="-1" role="dialog" aria-labelledby="dataTrainingModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="dataTrainingModalLabel">Tambah Data Training</h5>
