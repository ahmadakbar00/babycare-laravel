  ...
  <div class="row">
    ...
    <div class="col-md-3 col-sm-6 col-12">
      <div class="info-box bg-primary p-3">
        <span class="info-box-icon"><i class="fas fa-user"></i></span>
        <div class="info-box-content">
          <span class="info-box-text">Laporan Status Gizi Baik<span>
          <span class="info-box-number"><h4>{{$dataLaporanBaik}}</h4></span>
        </div>
      </div>
    </div>
    <div class="col-md-3 col-sm-6 col-12">
      <div class="info-box bg-danger p-3">
        <span class="info-box-icon"><i class="fas fa-user"></i></span>
        <div class="info-box-content">
          <span class="info-box-text">Laporan Status Gizi Kurang</span>
          <span class="info-box-number"><h4>{{$dataLaporanKurang}}</h4></span>
        </div>
      </div>
    </div>
    <div class="col-md-3 col-sm-6 col-12">
      <div class="info-box bg-warning p-3">
        <span class="info-box-icon"><i class="fas fa-user"></i></span>
        <div class="info-box-content">
          <span class="info-box-text">Laporan Status Gizi Lebih</span>
          <span class="info-box-number"><h4>{{$dataLaporanLebih}}</h4></span>
        </div>
      </div>
    </div>
