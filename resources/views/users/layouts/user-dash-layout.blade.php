        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <ul class="nav nav-treeview" style="display: block;">
              <li class="nav-item">
                <a href="{{route('user.addBaby')}}" class="nav-link {{(request()->is('user/addBaby*'))?'active':''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tambahkan Data Anak</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('user.babyDetail')}}" class="nav-link {{(request()->is('user/babyDetail*'))?'active':''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Detail Anak</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('user.history')}}" class="nav-link {{(request()->is('user/history*'))?'active':''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>History Laporan</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="{{route('user.article')}}" class="nav-link {{(request()->is('user/article*'))?'active':''}}">
